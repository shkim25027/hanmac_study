...
function initializePuzzle() {
  ...
  // 밝은 inner shadow (오른쪽 하단에서 빛 - 눌린 효과)
  ...
  feOffset1.setAttribute("dx", "10"); // 양수 = 오른쪽
  feOffset1.setAttribute("dy", "10"); // 양수 = 아래
  ...
  feFlood1.setAttribute("flood-color", "rgba(255, 255, 255, 0.6)");
  ...
  // 어두운 inner shadow (왼쪽 상단에서 그림자 - 눌린 효과)
  ...
  feOffset2.setAttribute("dx", "-8"); // 음수 = 왼쪽
  feOffset2.setAttribute("dy", "-8"); // 음수 = 위
