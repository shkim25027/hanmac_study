...
class ProgressIndicator {
  ...
  createIndicator() {
    ...
    this.indicator.innerHTML = `
      <svg width="131" height="128" viewBox="0 0 131 128" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- 퍼센트 텍스트 (동적으로 업데이트됨) -->
        <text class="progress-percent" x="66" y="20" text-anchor="middle" font-size="24" font-weight="bold" stroke="white" stroke-width="4" stroke-linejoin="round" stroke-linecap="round" paint-order="stroke fill" pointer-events="none">
          <tspan class="progress-label" fill="#7E5746">진도율 </tspan>
          <tspan class="progress-value" fill="#FF7033">0%</tspan>
        </text>
  ...
  _positionIndicator() {
    ...
    // 퍼센트 기반 위치 계산
    const percentX = (endPoint.x / viewBox.width) * 100 + 27;
    const percentY = (endPoint.y / viewBox.height) * 100 + 3;
