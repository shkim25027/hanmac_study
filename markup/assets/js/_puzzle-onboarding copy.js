...
class PuzzleManager {
  ...
  `;
    ...
    setTimeout(() => {
      ...
      // 애니메이션 종료 시 문구 (FINISH 모드: 온보딩 필수 콘텐츠 시청 완료 / 필요할 땐 언제든)
      this._showCelebrationEnd();
    }, 3500);
  }

  /** 애니메이션 시작 시 표시 (이름님 수고하셨습니다 / 온보딩 필수 콘텐츠 시청을 완료하셨습니다) */
  ...
  /** 애니메이션 종료 시 표시 (FINISH 모드: 완료 문구 + 필요할 땐 언제든) */
  _showCelebrationEnd() {
    if (CONFIG.COMPLETION_MODE !== "FINISH") return;
